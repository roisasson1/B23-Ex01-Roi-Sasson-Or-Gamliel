...
public class Program
{
    ...
    public static StringBuilder MessageToScreen()
    {
        ...
        message.AppendLine($"The string is {(IsPalindrom(userStr) ? "" : "not ")}a palindrom.");
    ...
    public static bool IsPalindrom(string i_usreStr)
    {
        ...
        else
        {
            ...
            {
                return IsPalindrom(i_usreStr.Substring(1, i_usreStr.Length - 2));
            }
        }
    }
